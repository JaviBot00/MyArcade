package com.hotguy.myarcade.games.snake;
...
public class GdxSnake extends ApplicationAdapter {
    ...
    public void create() {
        ...
        imgInicio = new Texture("snake/pantallaInicio.png");
        imgJuego = new Texture("snake/pantallaJuego.png");
        imgMuerto = new Texture("snake/pantallaMuerto.png");
        ...
        mMusica = Gdx.audio.newMusic(Gdx.files.internal("snake/AxelF.ogg"));
        mMusica.setLooping(true);
        mMuerto = Gdx.audio.newMusic(Gdx.files.internal("snake/MarioMuerto.ogg"));
